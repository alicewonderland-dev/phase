...
mod tests {
    ...
    /// The tournament chain spans SEVEN lobby versions: 4 introduced the
    ...
    /// credential-rotation idempotency, and 10 is a pre-emptive bump that
    /// adds nothing on this surface at all.
    ///
    ...
    /// no variant, moved ahead of new `GameFormat` variants; see that
    /// constant's own `/// 10` entry.
    #[test]
    fn the_tournament_chain_spans_lobby_versions_four_through_ten() {
